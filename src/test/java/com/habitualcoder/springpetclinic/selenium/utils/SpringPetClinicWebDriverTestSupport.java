...
public class SpringPetClinicWebDriverTestSupport extends TestState implements WithCustomResultListeners, WithTestState {
    ...
    private static final String LOCAL_APP_PORT="8080";
    private static final String LOCAL_APP_CONTEXT = "petclinic";
    //private static final String LOCAL_APP_STARTING_URL = String.format("http://localhost:%s/", LOCAL_APP_PORT, LOCAL_APP_CONTEXT);
    private static final String LOCAL_APP_STARTING_URL = String.format("http://localhost:%s/", LOCAL_APP_PORT);
